    ...
    return (
        <div className="relative flex flex-col">
            <input
                ...
                className="w-full max-w-xs border-0 rounded-sm outline-none ring-0 input bg-gray-700 focus:outline-0 focus:border-0 focus:ring-0"
            />

            <ul className={`${(data || isLoading) ? "block" : "hidden" } absolute z-50 top-full w-full max-h-[300px] overflow-scroll overflow-x-hidden p-2 rounded-md shadow bg-gray-700`}>
